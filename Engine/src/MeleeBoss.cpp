...
MeleeBoss::MeleeBoss(double newX, double newY, double newWidth, double newHeight, string newName)
{
    xPos = newX;
    yPos = newY;
    width = newWidth;
...
bool MeleeBoss::CheckCircleCollision()
{
    return false;
}

bool MeleeBoss::CheckCircleSquareCollision()
{
    return false;
}

bool MeleeBoss::CheckForwardCollision()
{
    for(auto& model : SceneManager::GetActiveScene()->staticObjects)
    {
